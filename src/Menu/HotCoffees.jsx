...
function HotCoffes() {
    return (
        <>
            ...
            <div >
                <h1 className='mt-16 ml-10 font-bold text-xl text-center'>SICAK KAHVELERİMİZ</h1>
                <div className='flex'>
                    ...
                    >
                        ...
                        <div className='relative h-64 w-64 ml-8 mt-8'>
                            ...
                            <div className="relative w-64 h-64 group overflow-hidden rounded-sm shadow-xl">
                                <img
                                    src='https://imgs.search.brave.com/pl9YMaidJCxX5bZ90Xe-LWdZWdAjF4IJSxGc5mI7NlA/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9jb2Zm/ZWVnZWVrLmNvbS93/cC1jb250ZW50L3Vw/bG9hZHMvMjAyNS8w/Mi9hbWVyaWNhbm8t/MS0xNTM2eDEwMjQu/anBn'
                                    alt='Americano'
                                    className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-110"
                                />
                                <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <span className="text-white text-xl font-semibold">Americano</span>
                                </div>
                            </div>
                    ...
                    >
                        ...
                        <div className='relative h-64 w-64 ml-5 mt-8'>
                            ...
                            <div className="relative w-64 h-64 group overflow-hidden rounded-sm shadow-lg">
                                <img
                                    src='https://imgs.search.brave.com/pMTaUUiIxt-LtxT6Votyi70gKaPQEJ96slzdolSiCXg/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9tZWRp/YS5nZXR0eWltYWdl/cy5jb20vaWQvMTM2/OTE1NDg5Ny9waG90/by9sYXR0ZS1jb2Zm/ZWUtb24tdGhlLXRh/YmxlLmpwZz9zPTYx/Mng2MTImdz0wJms9/MjAmYz0ydzVVWHND/T1hLc29sdDNVX1Na/ZVdWYzVTMHhDc19Q/NER3ajhHdEZGVmc0/PQ'
                                    alt='latte'
                                    className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-110"
                                />
                                <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <span className="text-white text-xl font-semibold">Latte</span>
                                </div>
                            </div>
                    ...
                    >
                        ...
                        <div className='relative h-64 w-64 ml-5 mt-8'>
                            ...
                            <div className="relative w-64 h-64 group overflow-hidden rounded-sm shadow-lg">
                                <img
                                    src='https://imgs.search.brave.com/hrTz51d5Ntp8aed2MWnhpK5VC4FMh7rW-cmuiv_VZvY/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90NC5m/dGNkbi5uZXQvanBn/LzA5Lzc1LzcyLzQ5/LzM2MF9GXzk3NTcy/NDk2Nl9pbzIydGh1/YU5CaEZtalp3a2pX/RzdlZ2YyU1pncnNn/Vi5qcGc'
                                    alt='Mocha'
                                    className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-110"
                                />
                                <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <span className="text-white text-xl font-semibold">Mocha</span>
                                </div>
                            </div>
